        ...
        return OrganisasiResDTO.DetailResponse.builder()
              ...
              .pengajuan(organisasi.getFormPengajuan().stream()
                    .map(data -> OrganisasiResDTO.Pengajuan.builder()
                          .uuid(data.getUuid())
                          .kode_jenis_seni(data.getJenisSeni() != null ? data.getJenisSeni().getKodeJenisSeni() : null)
                          .jenis_seni(data.getJenisSeni() != null ? data.getJenisSeni().getJenisSeni() : null)
                          ...
                          .status(data.getStatus() != null ? data.getStatus().name() : null)
                          .build())
                    .toList())
              .build();
    }
