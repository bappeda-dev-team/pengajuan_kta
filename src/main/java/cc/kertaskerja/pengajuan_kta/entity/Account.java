...
public class Account extends BaseAuditable {
    ...
    public Account(Long id, String nama, String username, String password, String nomorTelepon,
                   String tipeAkun, StatusEnum status, String role, String email,
    ...
    public static class Builder {
        ...
        public Builder nomorTelepon(String nomorTelepon) { this.nomorTelepon = nomorTelepon; return this; }
        public Builder tipeAkun(String tipeAkun) { this.tipeAkun = tipeAkun; return this; }
        public Builder status(StatusEnum status) { this.status = status; return this; }
        public Builder role(String role) { this.role = role; return this; }
        public Builder email(String email) { this.email = email; return this; }
        public Builder formPengajuan(List<FormPengajuan> formPengajuan) { this.formPengajuan = formPengajuan; return this; }

        public Account build() {
            return new Account(id, nama, username, password, nomorTelepon, tipeAkun, status, role, email, formPengajuan);
        }
    }
